...
#+BEGIN_SRC ipython :session mysession :file ./img/image_2.png :exports code
%matplotlib inline
import numpy as np
...
#+BEGIN_SRC ipython :session mysession :file ./img/image.png :exports code
...
#+begin_src ditaa :file ./img/blue.png :cmdline -r
+---------+
| cBLU    |
|         |
|    +----+
