...
#+BEGIN_SRC ipython :session p1 :results output :exports both
...
#+BEGIN_SRC ipython :session p1 :file ./img/image_2.png :exports code
%matplotlib inline
import numpy as np
...
#+BEGIN_SRC ipython :session p1 :file ./img/image.png :exports code
...
#+BEGIN_SRC ipython :session p1 :results value :exports both
def foo(x):
    return x + 9
...
#+begin_src python :results output :session p1
print "There are %d hours in a week." % (7*24)
2**10
#+end_src
